  ...
  def create
    ...
    respond_to do |format|
      if @changes_history.save
        format.html { redirect_to changes_history_url(@changes_history), notice: "Changes history was successfully created." }
  ...
  def update
    respond_to do |format|
      if @changes_history.update(changes_history_params)
        format.html { redirect_to changes_history_url(@changes_history), notice: "Changes history was successfully updated." }
